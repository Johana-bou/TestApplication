...
export default function RapprochementNouveau() {
  ...
  const soldeTheorique = soldeBalance + opAcct - opPoste
                  ...
                  <div className="d-flex align-items-start">
                    ...
                    <div>
                      ...
                      <div className="font-12 text-muted">
                        ...
                        <br />
                        <strong>Seuls les montants peuvent être modifiés.</strong>
                        {' '}L'intitulé et les informations du compte restent inchangés.
                      </div>
                    </div>
                  </div>
                </div>
              ...
              <div className="row text-center mt-20">
                <div className="col-6">
                  <div style={{ padding: '12px 8px', background: '#f8f9fa', borderRadius: 8 }}>
                    <div style={{ fontSize: 11, color: '#888', marginBottom: 4 }}>Solde théorique</div>
                    <div style={{ fontWeight: 700, color: '#7934f3', fontSize: 15 }}>
                      {soldeTheorique.toLocaleString('fr-FR')} FCFA
                    </div>
                  </div>
                </div>
                <div className="col-6">
          ...
          <div className="col-12">
            <button type="submit" className="btn btn-primary btn-block py-3"
              ...
              {mutation.isPending ? (
                ...
                <><i className="dw dw-save mr-2" />Mettre à jour les montants de {MOIS_LABELS[mois - 1]} {annee}</>
              ) : (
